 ...
 * @author ppash
 */
public class ViewPhysicalResources extends javax.swing.JFrame {

    /**
     * Creates new form ViewHumanResources
     */
    public ViewPhysicalResources() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("مشاهده منابع فیزیکی");

        jButton1.setText("افزودن منبع فیزیکی جدید");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"مودم", "۲۳۴۳", "ylinxZ", "نیم طبقه سوم", "پیاده‌سازی و نگهداری"},
                {"کابل شبکه", "۱۲۳۴", "tp-10", "سایت شماره ۲", "تحلیل"},
                {"کاغذ آ۴", "۹۹۹۹", "80gr", "انبار", "طراحی"}
            },
            new String [] {
                "نام", "کد", "مدل منبع", "محل قرارگیری", "واحد"
            }
        ) {
