 ...
 * @author ppash
 */
public class ViewNeededResourceReport extends javax.swing.JFrame {

    /**
     * Creates new form ViewAvailableResourceReport
     */
    public ViewNeededResourceReport() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("گزارش منابع موردنیاز در پروژه‌ها");

        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "گزارش منابع موردنیاز در پروژه‌ها", javax.swing.border.TitledBorder.RIGHT, javax.swing.border.TitledBorder.DEFAULT_POSITION));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAvailableResourceReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAvailableResourceReport().setVisible(true);
            }
        });
    }
