 ...
 * @author ppash
 */
public class ViewHumanResources extends javax.swing.JFrame {

    /**
     * Creates new form ViewHumanResources
     */
    public ViewHumanResources() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("مشاهده منابع انسانی");

        jButton1.setText("افزودن منبع انسانی جدید");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"آفاق", "انساندوست", null, "۹۱۱۰۶۴۴۹", "جاوا", "پروژه کاریابی (تحلیلگر)", "تحلیل"},
                {"گیتی", "انساندوست", null, "۹۱۱۰۰۰۰۰", "طراحی", "پروژه کاریابی (پیاده‌ساز)، پروژه گیشه (گرافیست)", "تحلیل"},
                {"ناهید", "انساندوست", null, "۹۲۲۲۲۲۲۲", "برنامه‌ریزی", null, "طراحی"},
                {"کامران", "انساندوست", null, "۹۲۲۲۲۰۱۱", "پایگاه‌داده", null, "پیاده‌سازی و نگهداری"}
            },
            new String [] {
                "نام", "نام خانوادگی", "پست شغلی در سازمان", "کد پرسنلی", "تخصص‌ها", "پروژه‌ها", "واحد"
            }
        ) {
