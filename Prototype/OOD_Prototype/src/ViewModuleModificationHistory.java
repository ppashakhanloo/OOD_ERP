 ...
 * @author ppash
 */
public class ViewModuleModificationHistory extends javax.swing.JFrame {

    /**
     * Creates new form ViewModuleModificationHistory
     */
    public ViewModuleModificationHistory() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("مشاهده تاریخچه تغییرات ماژول");

        jLabel3.setFont(new java.awt.Font("Tahoma", 0, 16)); // NOI18N
        jLabel3.setText("تاریخچه تغییرات ماژول شماره ۱");

        jTable1.setAutoCreateRowSorter(true);
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"Bug Fix", null, null, null},
                {"Performance Inmprovement", null, null, null}
            },
            new String [] {
                "نوع تغییر", "مدت زمان اعمال تغییر", "نام تغییردهنده(ها)", "نام منابع مصرف شده"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewModuleModificationHistory.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewModuleModificationHistory().setVisible(true);
            }
        });
    }
