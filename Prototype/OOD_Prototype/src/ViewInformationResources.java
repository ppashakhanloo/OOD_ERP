 ...
 * @author ppash
 */
public class ViewInformationResources extends javax.swing.JFrame {

    /**
     * Creates new form ViewHumanResources
     */
    public ViewInformationResources() {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("مشاهده منابع اطلاعاتی");

        jButton1.setText("افزودن منبع اطلاعاتی جدید");
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
                {"پایگاه‌داده دانشجویان", "db_stds.db", "طراحی"},
                {"فهرست اسامی شاکیان", "comp_list.xlsx", "پیاده‌سازی و نگهداری"}
            },
            new String [] {
                "نام", "محتویات", "واحد"
            }
